...
import { Bot, MessageSquare, LogOut, Plus, History, Trash } from "lucide-react"
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      ...
      <main className="flex-1 container py-6 px-4 md:py-12">
        {error && (
          <div className="mb-4 p-3 bg-destructive/15 text-destructive rounded-md text-center max-w-5xl mx-auto">
            {error}
          </div>
        )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="p-3 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors flex justify-between items-center">
                            <div className="flex-1 min-w-0">
                              <div className="font-medium truncate">
                                {conversation.messages[0]?.content.substring(0, 50) || "New Conversation"}...
                              </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Get started with NexusChat</CardDescription>
              </CardHeader>
                ...
                <div className="space-y-2">
                  ...
                  <div className="h-2 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{ width: `${Math.min(100, (conversations.length / 10) * 100)}%` }}
                    ></div>
                  </div>
                </div>
